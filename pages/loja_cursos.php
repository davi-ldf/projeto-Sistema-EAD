...
if(isset($_POST['adquirir'])) {
    //verify if the user is able to buy
    $id_user = $_SESSION['usuario'];
    $sql_query_creditos = $mysqli->query("SELECT creditos FROM usuarios WHERE id = '$id_user'") or die($mysqli->error); //pick user credits
    ...
    $sql_query_curso = $mysqli->query("SELECT preco FROM cursos WHERE id = '$id_curso'") or die($mysqli->error); //pick course price
        ...
        <div class="col-lg-8">
            <div class="page-header-title">
                <div class="d-inline">
                    ...
                    <span>Adquira nossos cursos utilizando os seus créditos.</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item">Loja de Cursos
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <button name="adquirir" type="submit" value="<?php echo $curso['id']; ?>" class="btn form-control btn-out-dashed btn-success btn-square">Adquirir - $<?php echo number_format($curso['preco'], 2, ',', '.'); ?></button>
                    </form>
                </div>
            </div>
        </div>
